export const UnauthenticatedEntitlements = {
  nameGenerations: 3,
  domainLookups: 0,
  npmNameLookups: 0,
...
export const ProPlanEntitlements = {
...
export const BusinessPlanEntitlements = {
...
export const TestFreePlanEntitlements = {
...
export const TestProPlanEntitlements = {
...
export const TestBusinessPlanEntitlements = {
